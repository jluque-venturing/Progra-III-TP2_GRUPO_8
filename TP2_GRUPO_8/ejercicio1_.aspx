<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ejercicio1_.aspx.cs" Inherits="TP2_GRUPO_8.WebForm1" %>
    ...
    <asp:Label ID="lblProducto2" runat="server" Text="Ingrese el nombre del producto:"></asp:Label>
                        ...
                        <td class="auto-style4">
                            ...
                            <asp:TextBox ID="TextBox2" runat="server" style="font-weight: 700" Width="187px"></asp:TextBox>
                        </td>
                        <td class="auto-style4"></td>
                        <td class="auto-style4"></td>
                        <td class="auto-style4"></td>
